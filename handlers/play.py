...
async def play(_, message: Message):
    ...
    lel = await message.reply("🔄 **𝙋𝙧𝙤𝙘𝙚𝙨𝙨𝙞𝙣𝙜**𝙐𝙡𝙩𝙧𝙖...")
    ...
    if audio:
        ...
        await lel.edit("🔎 **𝙁𝙞𝙣𝙙𝙞𝙣𝙜** 𝙎𝙤𝙣𝙜 𝙊𝙉 𝙃𝙚𝙭𝙤𝙧 𝙎𝙚𝙧𝙫𝙚𝙧...")
        sender_id = message.from_user.id
    ...
    if message.chat.id in callsmusic.pytgcalls.active_calls:
        ...
        photo="final.png", 
        caption=f"#⃣ 𝙎𝙤𝙣𝙜 𝙋𝙤𝙨𝙞𝙩𝙞𝙤𝙣 {position}!",
        ...
        photo="final.png",
        reply_markup=keyboard,
        caption="𝙎𝙤𝙣𝙜 𝙋𝙡𝙖𝙮 𝙊𝙉 𝙃𝙚𝙭𝙤𝙧 𝙎𝙚𝙧𝙫𝙚𝙧 𝘽𝙮 𝙈𝙧.𝙎𝙢𝙤𝙠𝙚𝙧".format(
